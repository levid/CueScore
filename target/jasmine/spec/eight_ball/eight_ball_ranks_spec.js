...
(function() {
  ...
  describe("Eight Ball Ranks", function() {
    var model;
    model = void 0;
    beforeEach(function() {
      return model = new $CS.Models.EightBall.Ranks();
    });
    return describe("Scoring", function() {
      it("should return the correct games needed to win for each model", function() {
        ...
        return expect(model.getGamesNeedToWin(8, 1)).toEqual(0);
      });
