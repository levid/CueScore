describe "EightBall Game", ->
  ...
  describe "Player Information", ->
    ...
    it "should be able to return the name of player one", ->
      expect(game.player.one.callback().name).toEqual "Isaac Wooten"
    
    it "should be able to return the name of player two", ->
      expect(game.player.two.callback().name).toEqual "James Armstead"
      
    it "should be able to return the rank of player one", ->
      expect(game.player.one.callback().rank).toEqual 1
    
    it "should be able to return the rank of player two", ->
      expect(game.player.two.callback().rank).toEqual 1
      
    it "should be able to return the player number of player two", ->
      expect(game.player.two.callback().number).toEqual '1'
